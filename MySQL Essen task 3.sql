...
CREATE TABLE humanResourcesBD.workers  
(	
...
CREATE TABLE humanResourcesBD.workingPosition 
(	
	 id INT AUTO_INCREMENT NOT NULL,
...
CREATE TABLE humanResourcesBD.workplace 
(	
	 id INT AUTO_INCREMENT NOT NULL,
     floorW int default 0, 	
     officeW int default 0, 
     tableW int default 0, 	
     automobile VARCHAR(3) default 'нет', 
     PRIMARY KEY (id)
);
...
CREATE TABLE humanResourcesBD.workingDays 
(	
	 id INT AUTO_INCREMENT NOT NULL,
...
CREATE TABLE humanResourcesBD.holiday 
(	
	 id INT AUTO_INCREMENT NOT NULL,
...
CREATE TABLE humanResourcesBD.basicSummary  
(	
	 id INT AUTO_INCREMENT NOT NULL,
     workersId int not null,
